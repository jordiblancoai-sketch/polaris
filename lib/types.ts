...
export const MOCK_SCORES: RankedOpportunity[] = [
  ...
  // Japan prefectures
  { rank: 1,  score: 78, confidence: "high",   target_entity_type: "region", target_entity_id: "32", target_entity_name: "Kyoto",          target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Historic educational hub with strong universities.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 2,  score: 76, confidence: "high",   target_entity_type: "region", target_entity_id: "33", target_entity_name: "Osaka",          target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Major metropolitan area with strong economic base.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 3,  score: 75, confidence: "high",   target_entity_type: "region", target_entity_id: "34", target_entity_name: "Tokyo",          target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "National capital with highest concentration of universities.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 4,  score: 74, confidence: "high",   target_entity_type: "region", target_entity_id: "35", target_entity_name: "Kanagawa",       target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Adjacent to Tokyo, strong educational institutions.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 5,  score: 72, confidence: "high",   target_entity_type: "region", target_entity_id: "36", target_entity_name: "Saitama",        target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Growing metropolitan region with good schools.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 6,  score: 70, confidence: "high",   target_entity_type: "region", target_entity_id: "37", target_entity_name: "Aichi",          target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Industrial hub with strong STEM pipeline.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 7,  score: 68, confidence: "high",   target_entity_type: "region", target_entity_id: "38", target_entity_name: "Fukuoka",        target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Major city in Kyushu with strong universities.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 8,  score: 65, confidence: "medium", target_entity_type: "region", target_entity_id: "39", target_entity_name: "Hiroshima",      target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Growing educational center in western Honshu.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  { rank: 9,  score: 62, confidence: "medium", target_entity_type: "region", target_entity_id: "40", target_entity_name: "Nagoya",         target_country_iso: "JPN", dest_country_iso: "USA", key_insight: "Central Japan with developing educational infrastructure.", risk_flag: null, optimal_visit_window: "Oct–Nov", top_factors: [], recommended_schools: [] },
  // Singapore regions
  { rank: 1,  score: 88, confidence: "high",   target_entity_type: "region", target_entity_id: "41", target_entity_name: "Central Region", target_country_iso: "SGP", dest_country_iso: "USA", key_insight: "Highest concentration of top-tier universities and institutions.", risk_flag: null, optimal_visit_window: "Aug–Sep", top_factors: [], recommended_schools: [] },
  { rank: 2,  score: 85, confidence: "high",   target_entity_type: "region", target_entity_id: "42", target_entity_name: "East Region",    target_country_iso: "SGP", dest_country_iso: "USA", key_insight: "Emerging educational hub with strong growth potential.", risk_flag: null, optimal_visit_window: "Aug–Sep", top_factors: [], recommended_schools: [] },
  { rank: 3,  score: 82, confidence: "high",   target_entity_type: "region", target_entity_id: "43", target_entity_name: "North Region",   target_country_iso: "SGP", dest_country_iso: "USA", key_insight: "Growing residential area with developing educational base.", risk_flag: null, optimal_visit_window: "Aug–Sep", top_factors: [], recommended_schools: [] },
  { rank: 4,  score: 80, confidence: "high",   target_entity_type: "region", target_entity_id: "44", target_entity_name: "West Region",    target_country_iso: "SGP", dest_country_iso: "USA", key_insight: "Industrial and residential mix with educational institutions.", risk_flag: null, optimal_visit_window: "Aug–Sep", top_factors: [], recommended_schools: [] },
  { rank: 5,  score: 79, confidence: "high",   target_entity_type: "region", target_entity_id: "45", target_entity_name: "Northeast Region", target_country_iso: "SGP", dest_country_iso: "USA", key_insight: "Developing area with emerging educational opportunities.", risk_flag: null, optimal_visit_window: "Aug–Sep", top_factors: [], recommended_schools: [] },
];
