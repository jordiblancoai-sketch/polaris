...
// Fix up a couple of name spellings in the GeoJSON to match MOCK_SCORES
...
export default function MapContent({ onProvinceSelect, selectedProvince }: Props) {
  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-navy-950 via-navy-900 to-navy-950 rounded-xl overflow-hidden">
      ...
      <ComposableMap
        ...
        projectionConfig={{ center: [104, 36], scale: 600 }}
        width={800}
        height={600}
